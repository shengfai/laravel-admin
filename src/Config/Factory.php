...
class Factory
{
    ...
    {
        //search the config menu for our item
        $options = $this->searchModel($this->name);
     ...
     *
     * @return \Shengfai\LaravelAdmin\Config\ConfigInterface
     */
     ...
     */
    public function searchModel($name, $models = false)
    {
        ...
        $config = false;
        $models   = $models ? $models : $this->options['models'];
        ...
        foreach ($models as $key => $item) {
            ...
            elseif (is_array($item)) {
                $config = $this->searchModel($name, $item);
            }
