...
<head>
    ...
    <link href="{{ asset('admin/plugs/uploader/webuploader.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('admin/plugs/uploader/theme/uploader.css') }}" rel="stylesheet" type="text/css"/>
    <script src="{{ asset('admin/plugs/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('admin/plugs/uploader/webuploader.min.js') }}"></script>
    <script src="{{ asset('admin/plugs/uploader/theme/upload.js') }}"></script>
</head>
<body>
<div id="uploader">
    <div class="queueList">
...
<script>
    ...
    $(function () {
        ...
        if (!WebUploader.Uploader.support('flash') && WebUploader.browser.ie) {
            ...
            if (flashVersion) {
                (function (container) {
                    ...
                    var swf = '/plugs/uploader/expressInstall.swf';
        ...
        WebUploader.Uploader.register({'before-send-file': 'preupload'}, {
            preupload: function (file) {
                ...
                owner.md5File(file.source).fail(function () {
                    ...
                    file.md5 = md5;
                    var data = {id: file.id, md5: md5, filename: file.name, _token:"{{ csrf_token() }}"};
                    $.ajax("{{ route('admin.plugs.upstate') }}", {
        ...
        uploader = WebUploader.create({
            ...
            fileNumLimit: 300,
            @endif
            server: "{{ route('admin.plugs.upload') }}",
            swf: "/admin/plugs/uploader/Uploader.swf",
            chunked: false,
            dnd: '#dndArea',
            paste: document.body,
            chunkSize: 512 * 1024,
