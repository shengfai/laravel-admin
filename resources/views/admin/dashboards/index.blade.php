<div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-sm6 layui-col-md3">
            <div class="layui-card">
                <div class="layui-card-header">
                    注册量 <span class="layui-badge layui-bg-orange layuiadmin-badge">7日</span>
                </div>
                <div class="layui-card-body layuiadmin-card-list">
                    <p class="layuiadmin-big-font text-center">
                        <a data-tips-text="七日" data-open="{{ route('admin.consumers.index', ['days'=>7]) }}">0</a>
                        <a data-tips-text="当天" data-open="{{ route('admin.consumers.index', ['days'=>1]) }}"><sub style="font-size: 14px">(0)</sub></a>
                    </p>
                    <p>
                        <span class="layuiadmin-middle-font">总注册量</span>
                        <span class="layuiadmin-span-color">
                            <a data-open="{{ route('admin.consumers.index') }}">0</a>
                        </span>
                    </p>
                </div>
            </div>
        ...
        <div class="layui-col-sm6 layui-col-md3">
            <div class="layui-card">
                <div class="layui-card-header">
                    机构数 <span class="layui-badge layui-bg-orange layuiadmin-badge">7日</span>
                </div>
                <div class="layui-card-body layuiadmin-card-list">
        ...
        <div class="layui-col-sm6 layui-col-md3">
            <div class="layui-card">
                <div class="layui-card-header">
                    任务数 <span class="layui-badge layui-bg-orange layuiadmin-badge">7日</span>
                </div>
                <div class="layui-card-body layuiadmin-card-list">
                    <p class="layuiadmin-big-font text-center">0</p>
                    <p>
                    ...
                    <div class="layui-row">
                        ...
                        <div class="layui-col-sm4">
                            <div class="layuiadmin-card-list">
                                <p class="layuiadmin-normal-font">月用户数：100000</p>
                                <span>环比增加</span>
                            ...
                            <div class="layuiadmin-card-list">
                                <p class="layuiadmin-normal-font">月用户数：10000</p>
                                <span>环比增加</span>
                                <div class="layui-progress layui-progress-big" lay-showpercent="yes">
